...
hl.bind(mainMod .. " + Return", hl.dsp.exec_cmd("grim ~/file.png"))
...
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("qs ipc call search toggle"),
...
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"),
	{ locked = true, repeating = true })
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("qs ipc call brightness increase 5%"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("qs ipc call brightness decrease 5%"),
	{ locked = true, repeating = true })
